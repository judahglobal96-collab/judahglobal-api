...
exports.createMajorEventRenewalCheckoutSession = exports.createOrgSubscriptionCheckoutSession = exports.getCheckoutSessionDetails = void 0;
...
exports.getCheckoutSessionDetails = getCheckoutSessionDetails;
const createOrgSubscriptionCheckoutSession = async (req, res) => {
    try {
        ...
        if (!orgAccountId || !orgUuid || !organizationName || !contactEmail) {
            return res.status(400).json({
                success: false,
                message: 'orgAccountId, orgUuid, organizationName, and contactEmail are required',
            });
        }
        ...
        const orgResult = await db_1.db.query(`
      SELECT
        id,
        org_uuid,
        organization_name,
...
exports.createOrgSubscriptionCheckoutSession = createOrgSubscriptionCheckoutSession;
const createMajorEventRenewalCheckoutSession = async (req, res) => {
    try {
...
exports.createMajorEventRenewalCheckoutSession = createMajorEventRenewalCheckoutSession;
