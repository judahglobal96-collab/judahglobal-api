...
exports.listOrganizationAccounts = listOrganizationAccounts;
exports.getOrganizationAccountById = getOrganizationAccountById;
exports.getOrganizationAccountByOwnerUserId = getOrganizationAccountByOwnerUserId;
exports.getOrganizationAccountByUuid = getOrganizationAccountByUuid;
exports.createOrganizationAccount = createOrganizationAccount;
exports.updateOrganizationAccount = updateOrganizationAccount;
exports.updateOrganizationAccountStatus = updateOrganizationAccountStatus;
exports.deleteOrganizationAccount = deleteOrganizationAccount;
...
const returningFields = `
  ...
  updated_at
`;
async function listOrganizationAccounts(params) {
    const values = [];
    const where = [];
  ...
  `;
    const result = await db_1.db.query(sql, values);
    return result.rows;
}
async function getOrganizationAccountById(id) {
    const sql = `
    ${baseSelect}
    WHERE oa.id = $1
    LIMIT 1
...
async function getOrganizationAccountByOwnerUserId(ownerUserId) {
    const sql = `
    ${baseSelect}
    ...
    LIMIT 1
  `;
    const result = await db_1.db.query(sql, [ownerUserId]);
    return result.rows[0] || null;
}
async function getOrganizationAccountByUuid(orgUuid) {
    const sql = `
    ${baseSelect}
    WHERE oa.org_uuid = $1
    LIMIT 1
  `;
    const result = await db_1.db.query(sql, [orgUuid]);
    return result.rows[0] || null;
}
async function createOrganizationAccount(input) {
    const status = input.status && allowedStatuses.includes(input.status)
        ? input.status
        : "pending";
...
async function updateOrganizationAccount(id, input) {
    const fields = [];
    const values = [];
...
async function updateOrganizationAccountStatus(id, status) {
    ...
    RETURNING
      ${returningFields}
  `;
    const result = await db_1.db.query(sql, [status, id]);
    return result.rows[0] || null;
}
async function deleteOrganizationAccount(id) {
