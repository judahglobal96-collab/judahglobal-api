...
exports.getMyEventMetadataForEdit = getMyEventMetadataForEdit;
exports.updateMyEventMetadata = updateMyEventMetadata;
...
async function getMyEventMetadataForEdit(req, res) {
    try {
...
async function updateMyEventMetadata(req, res) {
