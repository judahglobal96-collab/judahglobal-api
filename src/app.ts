...
import eventMediaRoutes from "./uploads/events/routes/eventMedia.routes";
import eventMediaModerationRoutes from "./uploads/events/routes/eventMediaModeration.routes";
...
app.use("/api/v1", eventMediaRoutes);
app.use("/api/v1/admin/event-media", eventMediaModerationRoutes);
