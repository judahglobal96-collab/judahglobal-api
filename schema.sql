...
ALTER TYPE public.placement_hold_item_status OWNER TO postgres;
...
ALTER TYPE public.placement_hold_session_status OWNER TO postgres;
...
ALTER TYPE public.placement_inventory_mode OWNER TO postgres;
...
ALTER TYPE public.placement_payment_status OWNER TO postgres;
...
ALTER TYPE public.placement_pricing_model OWNER TO postgres;
...
ALTER TYPE public.placement_product_type OWNER TO postgres;
...
ALTER TYPE public.placement_publication_approval_status OWNER TO postgres;
...
ALTER TYPE public.placement_publication_status OWNER TO postgres;
...
ALTER TYPE public.placement_reservation_status OWNER TO postgres;
...
ALTER TYPE public.placement_surface_channel_type OWNER TO postgres;
...
ALTER TYPE public.placement_window_unit OWNER TO postgres;
...
ALTER FUNCTION public.set_platform_users_updated_at() OWNER TO postgres;
...
ALTER TABLE public.ad_campaign_items OWNER TO postgres;
...
ALTER TABLE public.campaign_promo_media OWNER TO postgres;
...
ALTER TABLE public.event_action_logs OWNER TO postgres;
...
ALTER TABLE public.event_discovery_index OWNER TO postgres;
...
ALTER TABLE public.event_engagement OWNER TO postgres;
...
ALTER TABLE public.event_featured_placements OWNER TO postgres;
...
ALTER TABLE public.event_review_actions OWNER TO postgres;
...
ALTER TABLE public.event_status_history OWNER TO postgres;
...
ALTER TABLE public.event_submission_media OWNER TO postgres;
...
ALTER TABLE public.featured_placement_inventory OWNER TO postgres;
...
ALTER TABLE public.organization_accounts OWNER TO postgres;
...
ALTER SEQUENCE public.organization_accounts_id_seq OWNER TO postgres;
...
ALTER TABLE public.placement_hold_items OWNER TO postgres;
...
ALTER TABLE public.placement_hold_sessions OWNER TO postgres;
...
ALTER TABLE public.placement_inventory_rules OWNER TO postgres;
...
ALTER TABLE public.placement_products OWNER TO postgres;
...
ALTER TABLE public.placement_publications OWNER TO postgres;
...
ALTER TABLE public.placement_reservations OWNER TO postgres;
...
ALTER TABLE public.placement_surfaces OWNER TO postgres;
